...
class getSecurity_Listener_UserChecker_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_checker.main'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(($container->privates['Nucleos\\UserBundle\\Security\\UserChecker'] ?? ($container->privates['Nucleos\\UserBundle\\Security\\UserChecker'] = new \Nucleos\UserBundle\Security\UserChecker())));
    }
}
