...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/story'), [0 => 'ROLE_POWER_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/scenes'), [0 => 'ROLE_POWER_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/podcasts'), [0 => 'ROLE_POWER_USER', 1 => 'ROLE_MODERATOR', 2 => 'ROLE_ADMIN'], NULL);
