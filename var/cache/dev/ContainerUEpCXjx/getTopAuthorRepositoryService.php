 ...
 */
class getTopAuthorRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TopAuthorRepository' shared autowired service.
     *
     * @return \App\Repository\TopAuthorRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TopAuthorRepository.php';

        return $container->privates['App\\Repository\\TopAuthorRepository'] = new \App\Repository\TopAuthorRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
