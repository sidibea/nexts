...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($container->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'nucleos_user.user_listener' => ['privates', 'nucleos_user.user_listener', 'getNucleosUser_UserListenerService', true],
            'vich_uploader.listener.clean.uploader' => ['privates', 'vich_uploader.listener.clean.uploader', 'getVichUploader_Listener_Clean_UploaderService', true],
            'vich_uploader.listener.remove.uploader' => ['privates', 'vich_uploader.listener.remove.uploader', 'getVichUploader_Listener_Remove_UploaderService', true],
            'vich_uploader.listener.upload.uploader' => ['privates', 'vich_uploader.listener.upload.uploader', 'getVichUploader_Listener_Upload_UploaderService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'nucleos_user.user_listener' => '?',
            'vich_uploader.listener.clean.uploader' => '?',
            'vich_uploader.listener.remove.uploader' => '?',
            'vich_uploader.listener.upload.uploader' => '?',
        ]), [0 => 'vich_uploader.listener.clean.uploader', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 3 => 'vich_uploader.listener.remove.uploader', 4 => 'vich_uploader.listener.upload.uploader', 5 => 'nucleos_user.user_listener', 6 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
}
