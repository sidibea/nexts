 ...
 */
class getSceneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SceneRepository' shared autowired service.
     *
     * @return \App\Repository\SceneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SceneRepository.php';

        return $container->privates['App\\Repository\\SceneRepository'] = new \App\Repository\SceneRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
