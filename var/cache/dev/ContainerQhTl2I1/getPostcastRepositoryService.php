 ...
 */
class getPostcastRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostcastRepository' shared autowired service.
     *
     * @return \App\Repository\PostcastRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostcastRepository.php';

        return $container->privates['App\\Repository\\PostcastRepository'] = new \App\Repository\PostcastRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
