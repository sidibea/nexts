...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'Nucleos\\UserBundle\\Command\\ActivateUserCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\ActivateUserCommand', 'getActivateUserCommandService', true],
            'Nucleos\\UserBundle\\Command\\ChangePasswordCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\ChangePasswordCommand', 'getChangePasswordCommandService', true],
            'Nucleos\\UserBundle\\Command\\CreateUserCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\CreateUserCommand', 'getCreateUserCommandService', true],
            'Nucleos\\UserBundle\\Command\\DeactivateUserCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\DeactivateUserCommand', 'getDeactivateUserCommandService', true],
            'Nucleos\\UserBundle\\Command\\DemoteUserCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\DemoteUserCommand', 'getDemoteUserCommandService', true],
            'Nucleos\\UserBundle\\Command\\PromoteUserCommand' => ['privates', 'Nucleos\\UserBundle\\Command\\PromoteUserCommand', 'getPromoteUserCommandService', true],
            ...
            'Nucleos\\UserBundle\\Command\\ActivateUserCommand' => 'Nucleos\\UserBundle\\Command\\ActivateUserCommand',
            'Nucleos\\UserBundle\\Command\\ChangePasswordCommand' => 'Nucleos\\UserBundle\\Command\\ChangePasswordCommand',
            'Nucleos\\UserBundle\\Command\\CreateUserCommand' => 'Nucleos\\UserBundle\\Command\\CreateUserCommand',
            'Nucleos\\UserBundle\\Command\\DeactivateUserCommand' => 'Nucleos\\UserBundle\\Command\\DeactivateUserCommand',
            'Nucleos\\UserBundle\\Command\\DemoteUserCommand' => 'Nucleos\\UserBundle\\Command\\DemoteUserCommand',
            'Nucleos\\UserBundle\\Command\\PromoteUserCommand' => 'Nucleos\\UserBundle\\Command\\PromoteUserCommand',
