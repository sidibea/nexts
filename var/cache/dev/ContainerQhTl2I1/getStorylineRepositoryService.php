 ...
 */
class getStorylineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StorylineRepository' shared autowired service.
     *
     * @return \App\Repository\StorylineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StorylineRepository.php';

        return $container->privates['App\\Repository\\StorylineRepository'] = new \App\Repository\StorylineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
