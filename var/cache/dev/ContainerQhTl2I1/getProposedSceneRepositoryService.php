 ...
 */
class getProposedSceneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProposedSceneRepository' shared autowired service.
     *
     * @return \App\Repository\ProposedSceneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProposedSceneRepository.php';

        return $container->privates['App\\Repository\\ProposedSceneRepository'] = new \App\Repository\ProposedSceneRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
