...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\CallToActionController' => 'getCallToActionControllerService',
            ...
            'App\\Controller\\Admin\\ForumCrudController' => 'getForumCrudControllerService',
            'App\\Controller\\Admin\\SceneController' => 'getSceneControllerService',
            'App\\Controller\\Admin\\StoryController' => 'getStoryControllerService',
            'App\\Controller\\Admin\\TopAuthorsController' => 'getTopAuthorsControllerService',
            ...
            'App\\Controller\\ForumController' => 'getForumController2Service',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\MainController' => 'getMainControllerService',
            'App\\Controller\\PodcastController' => 'getPodcastControllerService',
            'App\\Controller\\ProposedSceneController' => 'getProposedSceneControllerService',
            'App\\Controller\\SceneController' => 'getSceneController2Service',
            ...
            'Nucleos\\UserBundle\\Action\\ChangePasswordAction' => 'getChangePasswordActionService',
            'Nucleos\\UserBundle\\Action\\CheckEmailAction' => 'getCheckEmailActionService',
            'Nucleos\\UserBundle\\Action\\CheckLoginAction' => 'getCheckLoginActionService',
            'Nucleos\\UserBundle\\Action\\LoginAction' => 'getLoginActionService',
            'Nucleos\\UserBundle\\Action\\LogoutAction' => 'getLogoutActionService',
            'Nucleos\\UserBundle\\Action\\RequestResetAction' => 'getRequestResetActionService',
            'Nucleos\\UserBundle\\Action\\ResetAction' => 'getResetActionService',
            'Nucleos\\UserBundle\\Action\\SendEmailAction' => 'getSendEmailActionService',
            'Nucleos\\UserBundle\\Model\\UserManager' => 'getUserManagerService',
            'Nucleos\\UserBundle\\Util\\TokenGenerator' => 'getTokenGeneratorService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.uploader' => 'getSmartUniqueNamer_UploaderService',
            ...
            'nucleos_user.group_manager' => 'getNucleosUser_GroupManagerService',
            'nucleos_user.mailer' => 'getNucleosUser_MailerService',
            'nucleos_user.util.email_canonicalizer' => 'getNucleosUser_Util_EmailCanonicalizerService',
        ...
        $this->aliases = [
            'App\\Kernel' => 'kernel',
            'Nucleos\\UserBundle\\Mailer\\ResettingMailer' => 'nucleos_user.mailer',
            'Nucleos\\UserBundle\\Model\\GroupManager' => 'nucleos_user.group_manager',
            'database_connection' => 'doctrine.dbal.default_connection',
            'doctrine.orm.entity_manager' => 'doctrine.orm.default_entity_manager',
            'nucleos_user.user_manager' => 'Nucleos\\UserBundle\\Model\\UserManager',
            'nucleos_user.util.token_generator' => 'Nucleos\\UserBundle\\Util\\TokenGenerator',
            'nucleos_user.util.username_canonicalizer' => 'nucleos_user.util.email_canonicalizer',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'nucleos'.\DIRECTORY_SEPARATOR.'user-bundle'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'LocaleEventListener.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('nucleos_user.security.implicit_login', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LastLoginListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LastLoginListener'] ?? $this->load('getLastLoginListenerService'));
        }, 1 => 'onImplicitLogin'], 0);
        $instance->addListener('security.interactive_login', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LastLoginListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LastLoginListener'] ?? $this->load('getLastLoginListenerService'));
        }, 1 => 'onSecurityInteractiveLogin'], 0);
        $instance->addListener('nucleos_user.resetting.reset.completed', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\AuthenticationListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\AuthenticationListener'] ?? $this->load('getAuthenticationListenerService'));
        }, 1 => 'authenticate'], 0);
        $instance->addListener('nucleos_user.security.implicit_login', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LocaleEventListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] ?? $this->getLocaleEventListenerService());
        }, 1 => 'onImplicitLogin'], 0);
        $instance->addListener('security.interactive_login', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LocaleEventListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] ?? $this->getLocaleEventListenerService());
        }, 1 => 'onSecurityInteractiveLogin'], 0);
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LocaleEventListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] ?? $this->getLocaleEventListenerService());
        }, 1 => 'onKernelRequest'], 20);
        $instance->addListener('nucleos_user.user.locale_changed', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LocaleEventListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] ?? $this->getLocaleEventListenerService());
        }, 1 => 'onLocaleChanged'], 0);
        $instance->addListener('nucleos_user.user.timezone_changed', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\LocaleEventListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] ?? $this->getLocaleEventListenerService());
        }, 1 => 'onTimezoneChanged'], 0);
        $instance->addListener('nucleos_user.change_password.edit.completed', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\FlashListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\FlashListener'] ?? $this->load('getFlashListenerService'));
        }, 1 => 'addSuccessFlash'], 0);
        $instance->addListener('nucleos_user.resetting.reset.completed', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\FlashListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\FlashListener'] ?? $this->load('getFlashListenerService'));
        }, 1 => 'addSuccessFlash'], 0);
        $instance->addListener('nucleos_user.account_deletion.success', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\FlashListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\FlashListener'] ?? $this->load('getFlashListenerService'));
        }, 1 => 'addSuccessFlash'], 0);
        $instance->addListener('nucleos_user.resetting.reset.initialize', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\ResettingListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\ResettingListener'] ?? $this->load('getResettingListenerService'));
        }, 1 => 'onResettingResetInitialize'], 0);
        $instance->addListener('nucleos_user.resetting.reset.success', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\ResettingListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\ResettingListener'] ?? $this->load('getResettingListenerService'));
        }, 1 => 'onResettingResetSuccess'], 0);
        $instance->addListener('nucleos_user.resetting.reset.request', [0 => #[\Closure(name: 'Nucleos\\UserBundle\\EventListener\\ResettingListener')] function () {
            return ($this->privates['Nucleos\\UserBundle\\EventListener\\ResettingListener'] ?? $this->load('getResettingListenerService'));
    ...
    {
        $a = ($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] ?? ($this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\ForumCrudController'])));
    ...
    /**
     * Gets the private 'Nucleos\UserBundle\EventListener\LocaleEventListener' shared service.
     *
     * @return \Nucleos\UserBundle\EventListener\LocaleEventListener
     */
    protected function getLocaleEventListenerService()
    {
        return $this->privates['Nucleos\\UserBundle\\EventListener\\LocaleEventListener'] = new \Nucleos\UserBundle\EventListener\LocaleEventListener(($this->services['translator'] ?? $this->getTranslatorService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xty-4IBmdR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['nucleos_user.user_provider.username'] ?? $this->load('getNucleosUser_UserProvider_UsernameService'));
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'nucleos'.\DIRECTORY_SEPARATOR.'user-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), 'NucleosUser');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'nucleos'.\DIRECTORY_SEPARATOR.'user-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), '!NucleosUser');
        ...
        $instance->addExtension(new \FOS\CKEditorBundle\Twig\CKEditorExtension(new \FOS\CKEditorBundle\Renderer\CKEditorRenderer(new \FOS\CKEditorBundle\Builder\JsonBuilder(($this->privates['property_accessor'] ?? $this->getPropertyAccessorService())), $g, $f, $d, $instance, (($this->hasParameter("locale")) ? ($this->getParameter("locale")) : (null)))));
    ...
    private $loadedDynamicParameters = [
        ...
        'nucleos_user.resetting.from_email' => false,
    ];
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'nucleos_user.resetting.from_email' => $this->getEnv('MAIL_SENDER'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'NucleosUserBundle' => 'Nucleos\\UserBundle\\NucleosUserBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'NucleosUserBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'nucleos'.\DIRECTORY_SEPARATOR.'user-bundle'.\DIRECTORY_SEPARATOR.'src'),
            ...
            'vich_uploader.mappings' => [
                'uploader' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.uploader',
                        'options' => [
            ...
            'nucleos_user.backend_type_orm' => true,
            'nucleos_user.storage' => 'orm',
            'nucleos_user.firewall_name' => 'main',
            'nucleos_user.model_manager_name' => NULL,
            'nucleos_user.model.user.class' => 'App\\Entity\\User',
            'nucleos_user.resetting.retry_ttl' => 7200,
            'nucleos_user.resetting.token_ttl' => 86400,
            'nucleos_user.loggedin.route' => 'home',
            'nucleos_user.model.group.class' => 'App\\Entity\\Group',
